...
public class ActivitiesFragement extends CustomFragment implements CustomFragment.ResponseCallback{

    private List<Deals> dealsList;
    private RecyclerView recyclerView;
    View.OnClickListener listener;
    DealsAdapter adapter;
 //   private ActivitiesFragement responseListener;
...
//                            deals.getString("address"));
            ...
            adapter = new DealsAdapter(dealsList, getApplicationContext(), new DealsAdapter.ClickListener() {
                ...
                public void onPositionClicked(int position) {
                   ...
                   // for (position = 0; position<dealsList.size(); position++) {
...
/*    public void setResponseListener(ActivitiesFragement responseListener) {
