...
public class TakeawaysFragment extends CustomFragment implements CustomFragment.ResponseCallback {
    private List<Deals> dealsList;
    private RecyclerView recyclerView;
    View.OnClickListener listener;
    DealsAdapter adapter;
  //  private TakeawaysFragment responseListener;
...
//                            deals.getString("address"));
                    add_deals.setCategory_name("category_name");
...
//            if (dealsList.size() == 0) {
//                MyApp.popFinishableMessage("MBiz Message", " ", getActivity());
//            }
        }
    }
 ...
 /*   public void setResponseListener(TakeawaysFragment responseListener) {
